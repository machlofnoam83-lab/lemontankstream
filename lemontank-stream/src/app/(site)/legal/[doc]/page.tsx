...
const DOCS: Record<string, { title: string; body: string[] }> = {
  ...
  cookies: {
    ...
    body: [
      "עוגיית סשן — הכרחית לניהול ההתחברות. httpOnly, SameSite=Lax. אינה מכילה מידע אישי, רק טוקן אקראי.",
      "עוגיית אבטחה — הכרחית להגנת CSRF (double submit). קריאה ל-JS לצורך שליחת הכותרת המתאימה.",
